...
{	
    ...
    atexit(SDL_Quit);
    if(SDL_VideoModeOK(640, 768, 32, SDL_ANYFORMAT | SDL_HWSURFACE))
    {
        S_Data.xres = 640;
        S_Data.yres = 480;
        S_Data.depth = 32;
    ...
    else if(SDL_VideoModeOK(640, 480, 16, SDL_ANYFORMAT | SDL_HWSURFACE))
    {
        S_Data.xres = 640;
        S_Data.yres = 480;
        S_Data.depth = 16;
    ...
    else if(SDL_VideoModeOK(640, 480, 16, SDL_ANYFORMAT))
    {
        S_Data.xres = 640;
        S_Data.yres = 480;
        S_Data.depth = 16;
